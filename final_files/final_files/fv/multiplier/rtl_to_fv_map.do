...
# Generated on: Tue Sep 30 15:09:53 IST 2025 (Tue Sep 30 09:39:53 UTC 2025)
...
set logfile fv/multiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
add_search_path /home/students/students/projects/Digital/multiplier -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  multiplier.v
...
set_system_mode lec
write_compared_points noneq.compared_points.multiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.multiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.multiplier.rtl.fv_map.rpt
